...
from Database_management import insert_record, retrieve_record_by_hash
...
def load_data_de(table_name, index_name, text_with_pii, file_name, file_hash, file_bytes, st_logger):
    ...
    insert_record(table_name, file_name, file_hash, file_bytes, text_with_pii, text_pii_deleted.text, text_pii_labeled.text, text_pii_synthetic, text_pii_dp_prompt, results_json)
...
def load_data(table_name, index_name, text_with_pii, file_name, file_hash, file_bytes, st_logger):
    ...
    st_logger.info(f"Presidio text analysis started on: {text_with_pii}")
    ...
    # text_pii_dp = diff_privacy_dp_prompt(text_with_pii)
    text_pii_dp = diff_privacy_diffractor(text_with_pii)
